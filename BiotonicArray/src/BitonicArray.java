 ...
 * Solution:
 *
 * Use three binary searches. 1) Locate the point in the array where ascending
 * switchines to descending 2) Perform binary search on each half of the array
 * for the target integer
 *
 */
